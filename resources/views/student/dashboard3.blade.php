    ...
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-6 text-center">
               ...
               <button type="submit" class="btn btn-light btn-lg ms-3" style="width: 200px;" disabled>{{ $absensi->jam_pulang }}</button>
               <div class="mt-3 ">
               <div class="alert alert-primary" role="alert">
                Terimakasih Atas Keterangan yang dilampirkan
              </div>
               </div>
               <form method="POST" action="{{ route('logout') }}">
                            @csrf

                            <button class="btn btn-primary mt-5" href="route('logout')"
